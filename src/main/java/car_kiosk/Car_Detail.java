...
//		enableCarList = CarDAO.getInstance().SelectTable(car);
		...
		ImageIcon image1;
		String url = String.format(".\\car_Image\\%s.png", car);
	...
	public void setSize(String size) {
		...
		chargeList=carDAO.getInstance().SelectCharge(size);
	
		chargeDTO = ChargeDTO.getInstance();
		chargeDTO.setCarSize(chargeList.get(i).getCarSize());
